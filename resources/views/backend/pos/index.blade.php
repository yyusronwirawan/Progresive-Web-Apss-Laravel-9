        ...
        <div class="row gutters-5">
            <div class="col-md pr-3">
                ...
                <div class="aiz-pos-product-list c-scrollbar-light">
                    <div class="d-flex flex-wrap justify-content-start" id="product-list">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#product-list').on('click','.add-plus:not(.c-not-allowed)',function(){
                var product_variation_combination_id = $(this).data('product_variation_combination_id');
                var variation_id = $(this).data('variation_id');
                $.post('{{ route('pos.addToCart') }}',{_token:AIZ.data.csrf, product_variation_combination_id:product_variation_combination_id,variation_id:variation_id}, function(data){
                    if(data.success == 1){
